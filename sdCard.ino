void saveData() {
  dataMessage = String(rtcdia) + "/" + String(rtcmes) + "/" + String(rtcano) + "," + String(rtchora) + ":" + String(rtcminuto) + ":" + String(rtcsegundo) + "," + String(gpsdia) + "/" + String(gpsmes) + "/" + String(gpsano) + "," + String(gpshora) + ":" + String(gpsminuto) + ":" + String(gpssegundo) + "," + String(latitudeStr) + "," + String(longitudeStr) + ","
                + String(gpsalt) + "," + String(gpsvel) + "," + String(aX) + "," + String(aY) + "," + String(aZ) + "," + String(aSqrt) + "," + String(gX) + "," + String(gY) + "," + String(gZ) + "," + String(mX) + "," + String(mY) + "," + String(mZ) + "," + String(mDirection) + "," + String(gpsUpdate) + "," + "\r\n";
...
void checkSDFile() {
  ...
  if (!file) {
    ...
    delay(1000);
    writeFile(SD, "/data.csv", "RTCData, RTCHora, GPSData, GPSHora, Lat, Long, Altgps, Vel, aX, aY, aZ, aSqrt, gX, gY, gZ, mX, mY, mZ, mDirection, GPSUpdate \r\n");
  } else {
